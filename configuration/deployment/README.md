---
description: Learn how to deploy Selenium to the cloud
---
...
Selenium is designed with a platform-agnostic architecture, ensuring compatibility with a wide range of deployment environments to suit your infrastructure needs.

## Local Machine

To deploy Selenium locally, follow our [Get Started](../../getting-started/) guide.
...
* [Elestio](https://elest.io/open-source/seleniumai)
...
* [GCP](gcp.md)
* [Kubernetes using Helm](https://artifacthub.io/packages/helm/cowboysysop/selenium)
