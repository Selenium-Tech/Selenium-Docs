...
If you are running both Selenium and Chroma on Docker, there are additional steps involved.
...
2. Open `docker-compose.yml` in Selenium
...
services:
    selenium:
        ...
        networks:
            - selenium_net
        command: /bin/sh -c "sleep 3; selenium start"
networks:
    selenium_net:
        name: chroma_net
        external: true
...
4. Spin up Selenium docker image
