---
description: Learn how to deploy Selenium on Digital Ocean
---
...
server {
    listen 80;
    listen [::]:80;
    server_name your_domain; #Example: demo.seleniumai.com
    location / {
...
You have successfully setup Selenium on your Droplet, with SSL certificate on your domain [🥳](https://emojipedia.org/partying-face/)

## Steps to update Selenium on Digital Ocean

1. Navigate to the directory you installed selenium in
...
3. Pull the latest Selenium Image

You can check the latest version release [here](https://github.com/SeleniumAI/Selenium/releases)
