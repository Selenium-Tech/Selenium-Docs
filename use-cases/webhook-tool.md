...
In Selenium, we are going to create a custom tool that is able to call the Webhook POST request, with the message body.
...
* **Tool Icon Src**: [https://github.com/SeleniumAI/Selenium/assets/26460777/517fdab2-8a6e-4781-b3c8-fb92cc78aa0b](https://github.com/SeleniumAI/Selenium/assets/26460777/517fdab2-8a6e-4781-b3c8-fb92cc78aa0b)
* **Input Schema**:
