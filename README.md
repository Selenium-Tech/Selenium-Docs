---
description: Welcome to the official Selenium documentation
---

# Introduction

<figure><img src=".gitbook/assets/selenium.gif" alt=""><figcaption><p>Selenium Drag &#x26; Drop UI</p></figcaption></figure>

## What is Selenium?

Selenium is an open source low-code tool for developers to build customized LLM orchestration flows & AI agents.
...
* [Using Selenium](using-selenium/README.md)
  * [Agentflows](using-selenium/agentflows/README.md)
    * [Multi-Agents](using-selenium/agentflows/multi-agents.md)
    * [Sequential Agents](using-selenium/agentflows/sequential-agents.md)
      * [Video Tutorials](using-selenium/agentflows/sequential-agents/video-tutorials.md)
  * [API](using-selenium/api.md)
  * [Analytic](using-selenium/analytic.md)
  * [Document Stores](using-selenium/document-stores.md)
  * [Embed](using-selenium/embed.md)
  * [Streaming](using-selenium/streaming.md)
  * [Telemetry](using-selenium/telemetry.md)
  * [Variables](using-selenium/variables.md)
...
* [Selenium GitHub](https://github.com/SeleniumAI)
* [Selenium Cloud](https://seleniumai.com/join)
