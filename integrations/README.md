---
description: Learn about all available integrations / nodes in Selenium
---
...
In Selenium, nodes are referred to as integrations. Similar to LEGO, you can build a customized LLM ochestration flow, a chatbot, an agent with all the integrations available in Selenium.
