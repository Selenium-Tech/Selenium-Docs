...
First, install Git and clone Selenium repository. You can follow the steps from the [Get Started](../getting-started/#for-developers) guide.

### Structure

Selenium separate every node integration under the folder `packages/components/nodes`. Let's try to create a simple Tool!
