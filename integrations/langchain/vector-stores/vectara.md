...
1. Register an account for [Vectara](https://vectara.com/integrations/selenium)
...
5. Back to Selenium canvas, and create your chatflow. Click **Create New** from the Credentials dropdown ane enter your Vectara credentials.
